...
describe('isTokenRefreshRequired tests', () => {
  it('when the token has already expired, then refresh is not reported as required', () => {
  ...
  describe('without an issued-at claim (falls back to a fixed 6-hour margin)', () => {
    ...
    it('when the token expires in thirty days, then refresh is not required', () => {
  ...
  describe('with an issued-at claim (50% of total lifetime)', () => {
    it('when less than 50% of the lifetime remains, then refresh is required', () => {
    ...
    it('when exactly 50% of the lifetime remains, then refresh is required', () => {
    ...
    it('when more than 50% of the lifetime remains, then refresh is not required', () => {
    ...
    it('when the token has a long lifetime, then refresh is not required until past the halfway point', () => {
