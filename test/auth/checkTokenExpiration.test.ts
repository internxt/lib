...
describe('checkTokenExpiration tests', () => {
  ...
  test('when the token expired one second ago, then it is EXPIRED', () => {
  ...
  describe('without an issued-at claim (falls back to a fixed 6-hour margin)', () => {
    test('when the token expires in three hours, then it is REFRESH_REQUIRED', () => {
    ...
    test('when the token expires in exactly six hours, then it is REFRESH_REQUIRED', () => {
    ...
    test('when the token expires in more than six hours, then it is VALID', () => {
    ...
    test('when the token expires in thirty days, then it is VALID', () => {
  ...
  describe('with an issued-at claim (50% of total lifetime)', () => {
    test('when less than 50% of the lifetime remains, then it is REFRESH_REQUIRED', () => {
      const now = Math.floor(Date.now() / 1000);
    ...
    test('when exactly 50% of the lifetime remains, then it is REFRESH_REQUIRED', () => {
    ...
    test('when more than 50% of the lifetime remains, then it is VALID', () => {
    ...
    test('when the token has a long lifetime, then it is VALID until past the halfway point', () => {
